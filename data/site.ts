...
const positioning: Record<Locale, Positioning> = {
  en: {
    statement: "NERA builds the technology underneath: from data to interface.",
    variants: [
  ...
  fr: {
    statement: "NERA construit la technologie qui se trouve en dessous : des données à l'interface.",
    variants: [
